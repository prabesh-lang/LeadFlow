...
export function SuperadminLeadsFiltersBar({
  ...
  return (
    <div className="rounded-xl border border-white/10 bg-lf-surface/90 p-4 sm:p-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex flex-wrap gap-2">
          <button
            type="button"
            onClick={apply}
            className="rounded-lg bg-lf-accent px-4 py-2 text-xs font-semibold text-white hover:bg-lf-accent-hover"
          >
            Apply
          </button>
          <button
            type="button"
            onClick={reset}
            className="rounded-lg border border-white/10 px-4 py-2 text-xs font-medium text-lf-text-secondary hover:bg-white/5"
          >
            Reset
          </button>
        </div>
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
        <label className="block text-xs font-medium text-lf-subtle">
          ...
          <input
            ...
            className="mt-1.5 block w-full min-h-10 rounded-lg border border-white/10 bg-lf-bg px-3 py-2 text-sm text-lf-text outline-none ring-lf-accent/30 focus:ring-2 [color-scheme:dark]"
          />
        </label>
        <label className="block text-xs font-medium text-lf-subtle">
          To
        ...
        <label className="block text-xs font-medium text-lf-subtle">
          ...
          <select
            ...
            className="mt-1.5 block w-full min-h-10 rounded-lg border border-white/10 bg-lf-bg px-3 py-2 text-sm text-lf-text outline-none ring-lf-accent/30 focus:ring-2"
          >
        ...
        <label className="block text-xs font-medium text-lf-subtle">
          ...
          <select
            ...
            className="mt-1.5 block w-full min-h-10 rounded-lg border border-white/10 bg-lf-bg px-3 py-2 text-sm text-lf-text outline-none ring-lf-accent/30 focus:ring-2 disabled:cursor-not-allowed disabled:opacity-50"
          >
